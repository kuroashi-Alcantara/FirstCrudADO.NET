...
namespace FirstCrudProduct.ProductsDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ID], [Name], [Price], [Amount]) VALUES (@ID, @Name" +
                ", @Price, @Amount)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FirstCrudProduct.Properties.Settings.Default.ProductsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Price, Amount FROM dbo.Products";
        ...
        public virtual int Insert(int ID, string Name, decimal Price, int Amount) {
